            ...
            {[
              ...
              <button
                ...
                onClick={() =>
                  label === "Convert"
                    ? go("convert")
                    : notify(`${label} is available in the wallet flow`)
                }
              >
                <span>
                  <Icon size={19} />
        ...
        <Screen name="wallet" active={route === "wallet"}>
          ...
          <section className="watchlist">
            {(balances.length
              ...
              <div className="market-row" key={item.asset}>
          ...
          {user ? (
            <section className="profile-panel">
              ...
              <div className="settings-list">
                <button
                  onClick={() =>
                    notify("API keys are not enabled for this simulated wallet")
                  }
                >
                  API keys <Chevron />
                </button>
                <button
                  onClick={() =>
                    notify("Notification settings will be available soon")
                  }
                >
...
function MarketList({ market, rate, limit }) {
    ...
    <main className="auth-shell">
      <section className="auth-card">
        ...
        <div className="auth-methods">
          <button className="method active">Email</button>
          <button
            className="method"
            type="button"
            onClick={() => setError("Phone OTP sign-in is not connected yet.")}
          >
            Phone
          </button>
        </div>
