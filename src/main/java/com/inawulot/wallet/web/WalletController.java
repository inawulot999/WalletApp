...
public class WalletController {
    ...
    public WalletBalanceResponse fund(@PathVariable UUID userId, @Valid @RequestBody FundWalletRequest request, Authentication authentication) {
    ...
    @GetMapping("/{userId}")
    public List<WalletBalanceResponse> balances(@PathVariable UUID userId, Authentication authentication) {
        currentUser.require(userId, authentication);
    ...
    public List<LedgerEntryResponse> ledger(@PathVariable UUID userId, Authentication authentication) {
        currentUser.require(userId, authentication);
